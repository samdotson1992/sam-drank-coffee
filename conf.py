...
BLOG_TITLE = "coffee + code "  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = ""
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https:\\\\samdrankcoffee.com/"
BLOG_EMAIL = "samdotson1992@gmail.com"
BLOG_DESCRIPTION = "Random things I do under the influence of caffeine."  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = 'https-samdotson1992-github-io-sam-drank-coffee'
